  ...
  const categories = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          to: "/merchandizing/store-clustering-engine",
          icon: Store,
          highlight: true,
        ...
        },
        {
          ...
          to: "/merchandizing/space-elasticity",
          icon: TrendingUp,
          highlight: true,
        ...
        },
        {
          ...
          to: "/merchandizing/space-allocation-optimizer",
          icon: LayoutGrid,
          highlight: true,
      ...
      items: [
        {
          ...
          to: "/merchandizing/mnl-demand-model",
          icon: BrainCircuit,
          highlight: true,
        ...
        },
        {
          ...
          to: "/merchandizing/sku-optimizer",
          icon: Box,
          highlight: true,
        ...
        },
        {
          ...
          to: "/merchandizing/monte-carlo-simulation",
          icon: Dices,
          highlight: true,
        ...
        },
        {
          ...
          to: "/merchandizing/solver-approaches",
          icon: Columns3,
          highlight: true,
